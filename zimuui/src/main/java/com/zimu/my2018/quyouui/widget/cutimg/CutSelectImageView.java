package com.zimu.my2018.quyouui.widget.cutimg;
 ...
 */
public class CutSelectImageView extends android.support.v7.widget.AppCompatImageView {
    private static final String TAG = CutSelectImageView.class.getSimpleName();
    ...
    public CutSelectImageView(Context context) {
        this(context, null);
    }

    public CutSelectImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CutSelectImageView(Context context, AttributeSet attrs, int defStyle) {
